...
#'
#' @param x A DynComm object, if not using the inline version of the
#'   function call
#'
#' @param ... Any future additional parameters
#'
...
#' }
#'
postProcess.DynComm <- function(x,actions=NULL,...){
  return(x$postProcess(actions))
}

#' @export
postProcess <- function (x,actions=NULL, ...) {
  UseMethod("postProcess", x)
}
...
#' }
#'
select.DynComm <- function(x,postProcessing=POSTPROCESSING$NONE, id=1,...){
  return(x$select(postProcessing=POSTPROCESSING$NONE, id=1))
}

#' @export
select <- function (x,postProcessing=POSTPROCESSING$NONE, id=1, ...) {
  UseMethod("select", x)
}
...
#' }
#'
results.DynComm <- function(x,differential=TRUE,...){
  return(x$results(differential))
}

#' @export
results <- function (x,differential=TRUE, ...) {
  UseMethod("results", x)
}

#' @name addRemoveEdges
#'
#' @aliases addRemove add addRemove.DynComm add.DynComm
#'
...
#' addRemoveEdges(x,graphAddRemove, ...)
# addRemove(graphAddRemove)
#' addRemove(x,graphAddRemove, ...)
# add(graphAddRemove)
#' add(x,graphAddRemove, ...)
#'
...
#' }
#'
addRemoveEdges.DynComm <- function(x,graphAddRemove,...){
  return(x$addRemoveEdges(graphAddRemove))
}
addRemove.DynComm <- function(x,graphAddRemove,...){
  return(x$addRemoveEdges(graphAddRemove))
}
add.DynComm <- function(x,graphAddRemove,...){
  return(x$addRemoveEdges(graphAddRemove))
}

#' @export
addRemoveEdges <- function (x,graphAddRemove, ...) {
  UseMethod("addRemoveEdges", x)
}

#' @export
addRemove <- function (x,graphAddRemove, ...) {
  UseMethod("addRemoveEdges", x)
}

#' @export
add <- function (x,graphAddRemove, ...) {
  UseMethod("addRemoveEdges", x)
}
...
#'}
#'
communityCount.DynComm <- function(x,...){
  return(x$communityCount())
}

#' @export
communityCount <- function (x, ...) {
  UseMethod("communityCount", x)
}
...
#'}
#'
communities.DynComm = function(x,...){
  return(x$communities())
}

#' @export
communities <- function (x, ...) {
  UseMethod("communities", x)
}
...
#'}
#'
communitiesEdgeCount.DynComm=function(x,...) {
  return(x$communitiesEdgeCount())
}

#' @export
communitiesEdgeCount <- function (x, ...) {
  UseMethod("communitiesEdgeCount", x)
}
...
#'}
#'
communityNeighbours.DynComm <- function(x,community,...){
  return(x$communityNeighbours(community))
}

#' @export
communityNeighbours <- function (x,community, ...) {
  UseMethod("communityNeighbours", x)
}
...
#' communityInnerEdgesWeight(x,community, ...)
#'
...
#'}
#'
communityInnerEdgesWeight.DynComm <- function(x,community,...){
  return(x$communityInnerEdgesWeight(community))
}

#' @export
communityInnerEdgesWeight <- function (x,community, ...) {
  UseMethod("communityInnerEdgesWeight", x)
}
...
#' communityTotalWeight(x,community, ...)
#'
...
#'}
#'
communityTotalWeight.DynComm <- function(x,community,...){
  return(x$communityTotalWeight(community))
}

#' @export
communityTotalWeight <- function (x,community, ...) {
  UseMethod("communityTotalWeight", x)
}
...
#' communityEdgeWeight(x,source,destination, ...)
#'
...
#'}
#'
communityEdgeWeight.DynComm <- function(x,source,destination,...){
  return(x$communityEdgeWeight(source,destination))
}

#' @export
communityEdgeWeight <- function (x,source,destination, ...) {
  UseMethod("communityEdgeWeight", x)
}

#' @name communityVertexCount
#'
#' @aliases communityNodeCount communityNodeCount.DynComm
#'
...
#' communityVertexCount(x,community, ...)
# communityNodeCount(community)
#' communityNodeCount(x,community, ...)
#'
...
#'}
#'
communityVertexCount.DynComm <- function(x,community,...){
  return(x$communityVertexCount())
}
communityNodeCount.DynComm <- function(x,community,...){
  return(x$communityVertexCount())
}

#' @export
communityVertexCount <- function (x,community, ...) {
  UseMethod("communityVertexCount", x)
}

#' @export
communityNodeCount <- function (x,community, ...) {
  UseMethod("communityVertexCount", x)
}
...
#'}
#'
community.DynComm <- function(x,vertex,...){
  return(x$community(vertex))
}

#' @export
community <- function (x,vertex, ...) {
  UseMethod("community", x)
}

#' @name vertexCount
#'
#' @aliases nodeCount nodeCount.DynComm
#'
#' @title vertexCount
#'
#' @author poltergeist0
...
#'}
#'
vertexCount.DynComm <- function(x,...){
  return(x$vertexCount())
}
nodeCount.DynComm <- function(x,...){
  return(x$vertexCount())
}

#' @export
vertexCount <- function (x, ...) {
  UseMethod("vertexCount", x)
}

#' @export
nodeCount <- function (x, ...) {
  UseMethod("vertexCount", x)
}

#' @name verticesAll
#'
#' @aliases nodesAll nodesAll.DynComm
#'
#' @title verticesAll
#'
#' @author poltergeist0
...
#'}
#'
verticesAll.DynComm <- function(x,...){
  return(x$verticesAll())
}
nodesAll.DynComm <- function(x,...){
  return(x$verticesAll())
}

#' @export
verticesAll <- function (x, ...) {
  UseMethod("verticesAll", x)
}
...
#'}
#'
edgeCount.DynComm=function(x,...) {
  return(x$edgeCount())
}

#' @export
edgeCount <- function (x, ...) {
  UseMethod("edgeCount", x)
}
...
#'}
#'
neighbours.DynComm <- function(x,vertex,...){
  return(x$neighbours(vertex))
}

#' @export
neighbours <- function (x,vertex, ...) {
  UseMethod("neighbours", x)
}
...
#' edgeWeight(x,source,destination, ...)
#'
...
#'}
#'
edgeWeight.DynComm <- function(x,source,destination,...){
  return(x$edgeWeight(source,destination))
}

#' @export
edgeWeight <- function (x,source,destination, ...) {
  UseMethod("edgeWeight", x)
}

#' @name vertices
#'
#' @aliases nodes nodes.DynComm
#'
#' @title vertices
#'
#' @author poltergeist0
...
#'}
#'
vertices.DynComm <- function(x,community,...){
  return(x$vertices(community))
}
nodes.DynComm <- function(x,community,...){
  return(x$vertices(community))
}

#' @export
vertices <- function (x,community, ...) {
  UseMethod("vertices", x)
}

#' @export
nodes <- function (x,community, ...) {
  UseMethod("vertices", x)
}
...
#'}
#'
communityMapping.DynComm <- function(x,differential=TRUE, file="",...){
  return(x$communityMapping(differential,file))
}

#' @export
communityMapping <- function (x,differential=TRUE, file="", ...) {
  UseMethod("communityMapping", x)
}
...
#' }
#'
time.DynComm <- function(x,differential=FALSE,...){
 return(x$time(differential))
}

#' @export
time <- function (x,differential=FALSE, ...) {
  UseMethod("time", x)
}
